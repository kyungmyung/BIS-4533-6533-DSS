...
x = data[['AccountBalance','AnomalyScore','TransactionAmount', 'Age', 'SuspiciousFlag', 'Amount']]
...
for i in range(100):
    ...
    model.add(tf.keras.layers.Flatten(input_shape=(6,)))
...
average_accuracy = np.mean(accuracy_save)
