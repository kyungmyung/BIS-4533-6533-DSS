...
x = data[['Current Assets - Total', 'Assets - Total', 'Cash', 'Research and Development Expense','Advertising Expense']]
...
plt.title('Actual vs Predicted Sales/Turnover (Net) - Last 50 Samples')
plt.xlabel('Samples')
